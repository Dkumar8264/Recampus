...
export function MyListingsPage() {
  ...
  const visibleListings = listings.filter((listing) => {
    ...
    const searchableText = [listing.title, listing.description, listing.category, listing.location]
      .filter(Boolean)
  ...
  return (
    <section>
      ...
      {isLoading ? (
        ...
        <div className="mt-8 rounded-[28px] border border-dashed border-stone-300 bg-white/85 p-8 text-center shadow-[0_24px_70px_rgba(64,43,20,0.1)]">
