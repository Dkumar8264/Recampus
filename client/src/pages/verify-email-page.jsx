    ...
    <AuthFormCard title="Verify email" subtitle="Enter the 6-digit code sent to your college inbox.">
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full rounded-md bg-campus px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#135a72] disabled:cursor-not-allowed disabled:opacity-70"
        >
      ...
      <button
        ...
        className="mt-4 min-h-11 rounded-md border border-stone-300 px-4 py-2 text-sm font-semibold text-stone-800 transition hover:bg-stone-50"
      >
        Resend code
      </button>
    </AuthFormCard>
